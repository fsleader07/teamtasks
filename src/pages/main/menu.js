const Menu = {
    render(currentPath = 'home') {
        ...
        return `
        <aside class="sidebar-dark w-64 flex-shrink-0 flex flex-col shadow-xl z-50">
            <div class="p-4 flex items-center gap-3 border-b border-gray-700">
                ...
                <span class="text-white text-lg font-semibold tracking-tight">Admin Task Pro</span>
            </div>
